...
@WebServlet("/UserMoviesDatesServlet2")
public class UserMoviesDatesServlet2 extends HttpServlet {
        ...
        try {
            if (selectedMovieIdParam != null && !selectedMovieIdParam.isEmpty()
                ...
                try (Connection connection = ConnectionUtil.getConnection()) {
                    ...
                    RequestDispatcher dispatcher = request.getRequestDispatcher("/UserMoviesDates2.jsp");
