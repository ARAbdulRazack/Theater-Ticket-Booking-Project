...
@WebServlet("/UserBookingServlet2")
public class UserBookingServlet2 extends HttpServlet {
        ...
        try {
            if (selectedUserIdParam != null && !selectedUserIdParam.isEmpty()) {
                ...
                try (Connection connection = ConnectionUtil.getConnection()) {
                    ...
                    RequestDispatcher dispatcher = request.getRequestDispatcher("/UserBookingHistory2.jsp");
