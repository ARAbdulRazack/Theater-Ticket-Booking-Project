...
@WebServlet("/UserShowTimesServlet")
public class UserMoviesTimeServlet extends HttpServlet {
        ...
        try {
            if (isValidParams(selectedMovieIdParam, selectedTheaterIdParam, selectedDate)) {
                ...
                try (Connection connection = ConnectionUtil.getConnection()) {
                    ...
                    RequestDispatcher dispatcher = request.getRequestDispatcher("/UserMoviesTime.jsp");
